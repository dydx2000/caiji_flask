...
conn = pymysql.connect("10.10.10.12", 'root', '0329', 'renthouse', charset='utf8', port=3306)
...
def getTenants():
    ...
    try:
        ...
        for result in rv:
            ...
            content = {'name': result[1], 'tel': result[2], 'room': result[3], 'startdate': startdate,
                       'enddate': enddate}
...
def save():
    ...
    insert into tenant (姓名,手机,房间号,承租日期,到期日期) values("{}","{}","{}","{}","{}");
    '''.format(addname, addphone, addroom, addstart, addend)
